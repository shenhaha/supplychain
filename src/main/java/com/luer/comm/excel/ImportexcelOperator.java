...
//workbook.close();
        ...
        for (int k = 1; k < 13; k++) {
            ...
            if (null != list.get(k)[1]) {
                operator.setUpdateTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(list.get(k)[1]));
            }
            if (null != list.get(k)[2]) {
                operator.setUpdateTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(list.get(k)[2]));
            }
            if (null != list.get(k)[3]) {
                operator.setUsername(list.get(k)[3]);
            }
            ...
            /*if (null != list.get(k)[6]) {
                operator.setRole(list.get(k)[6]);
            }
            if (null != list.get(k)[7]) {
                operator.setState(list.get(k)[7]);
            }*/
            if (null != list.get(k)[6]) {
                operator.setPhoneNumber(list.get(k)[6]);
            }
            if (null != list.get(k)[7]) {
                operator.setEmail(list.get(k)[7]);
            }
