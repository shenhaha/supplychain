...
public class Purchasemdetail {
    ...
    private Double warehouseTaxprice;
    ...
    public Double getWarehouseTaxprice() {
        return warehouseTaxprice;
    }

    public void setWarehouseTaxprice(Double warehouseTaxprice) {
    ...
    public Double getFreightShare() {
        return freightShare;
    }

    public void setFreightShare(Double freightShare) {
        this.freightShare = freightShare;
    }
