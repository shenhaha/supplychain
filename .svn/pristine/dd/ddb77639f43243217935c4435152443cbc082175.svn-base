                    ...
                    <div class="pull-left" >
                        <ol class="breadcrumb">
                           <%-- <li><a href="${ctx}/index">首页</a></li>--%>
                            <li id="point1" class="active">已放弃</li>
                            <input type="button" id="type1" class='btn btn-primary btn-sm' onclick="change1()" value="已签约" >
                            <input type="button" id="type2" class='btn btn-primary btn-sm' onclick="change2()" value="已放弃" style="display: none">
...
<script>
    ...
    $(function () {
        ...
        var ft = FooTable.init('#customtab', {
            ...
            "rows": $.get("${ctx}/businessmanager/getVisitor3?classification=3&level=" + '已放弃' + "&storeId=" + '<%=session.getAttribute("storeId")%>'),
            editing: {
                enabled: true,
                addRow: function () {
                    //新增模态框
    ...
    function change1() {
        window.location.href = "${ctx}/businessmanager/visit4" ;
