                    ...
                    <div class="pull-left" >
                        <ol class="breadcrumb">
                           <%-- <li><a href="${ctx}/index">首页</a></li>--%>
                            <li id="point1" class="active">追踪中</li>
                            ...
                            <input type="button" id="type3" class='btn btn-primary btn-sm' onclick="change3()" value="追踪中" style="display: none">
                        </ol>
                    </div>
...
<script>
    ...
    $(function () {
        ...
        var ft = FooTable.init('#customtab', {
            ...
            "rows": $.get("${ctx}/businessmanager/getVisitor3?classification=3&level=" + '追踪中' + "&storeId=" + '<%=session.getAttribute("storeId")%>'),
            editing: {
                enabled: true,
                addRow: function () {
                    //新增模态框
